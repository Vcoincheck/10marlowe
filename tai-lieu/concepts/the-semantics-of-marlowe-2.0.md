...
### The `applyTransaction` function[​](broken-reference) <a href="#the-applytransaction-function" id="the-applytransaction-function"></a>
...
### Action processing[​](broken-reference) <a href="#action-processing" id="action-processing"></a>
...
### Non-action input processing​ <a href="#non-action-input-processing" id="non-action-input-processing"></a>
...
### Combinators and `Null`​ <a href="#combinators-and-null" id="combinators-and-null"></a>
